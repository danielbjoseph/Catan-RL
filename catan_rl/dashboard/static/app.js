...
function buildBoard() {
  ...
  // Calculate board center from playable hexes only (first 19), not water hexes
  const playableHexCount = 19;
  const playableHexCenters = geo.hex_centers.slice(0, playableHexCount);
